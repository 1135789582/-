...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/jsp/dlprovider.action",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/proView.action?proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/upProviderView.action?proid="+ obj.attr("proid");
	});
