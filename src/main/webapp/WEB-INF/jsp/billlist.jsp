...
<div class="right">
       ...
       <form method="get" action="${pageContext.request.contextPath }billlist">
			...
			<select name="providerId">
				<c:if test="${providerPager.datas != null }">
				   <option value="0">--请选择--</option>
				   <c:forEach items="${providerPager.datas}" var="provider">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach items="${billPager.datas}" var="bill">
				<tr>
					<td>
	...
	<%--总页码--%>
	<input type="hidden" id="totalPageCount" value="${billPager.totalPage}"/>
	<c:import url="billpage.jsp"></c:import>
  </div>
</section>
